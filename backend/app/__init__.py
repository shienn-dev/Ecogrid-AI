...
def create_app(config_class=Config):
    ...
    app = Flask(__name__, static_folder=_frontend if _os.path.isdir(_frontend) else None, static_url_path="")
    ...
    def set_security_headers(response):
        ...
        response.headers["Content-Security-Policy"] = "default-src 'self'; script-src 'self' https://cdn.jsdelivr.net https://cdnjs.cloudflare.com; style-src 'self' https://fonts.googleapis.com https://cdnjs.cloudflare.com 'unsafe-inline'; font-src 'self' https://fonts.gstatic.com https://cdnjs.cloudflare.com; img-src 'self' data:; connect-src 'self' https://cdn.jsdelivr.net"
    ...
    def bad_request(e):
        ...
        if "Failed to decode" in str(msg) or "could not understand" in str(msg) or "Bad Request" in str(e):
